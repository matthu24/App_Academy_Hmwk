...
describe Dessert do
  ...
  let(:brownie) { Dessert.new("brownie",50,"Matt")}
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect{Dessert.new("brownie","fifty","Matt")}.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(brownie.serve).to eq("Matt has made 50 brownies!")
    end
  end
