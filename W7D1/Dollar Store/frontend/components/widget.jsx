...
class Widget extends React.Component {
  ...
  fetchRates(currency) {
    $.ajax({
      ...
      success: function(resp) {
        ...
        //this dispatches the action selectCurrency to the store
        //while passing in base and rates from the ajax request
  ...
  render() {
    ...
    const currencyOptions = this.currencies.map( (currency) => (
      //when clicking the specific currency, fetch rates is called 
